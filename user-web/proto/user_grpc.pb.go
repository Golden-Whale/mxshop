...
type UserClient interface {
	...
	GetUserByMobile(ctx context.Context, in *MobileReqeust, opts ...grpc.CallOption) (*UserInfoResponse, error)
	GetUserById(ctx context.Context, in *IdReqeust, opts ...grpc.CallOption) (*UserInfoResponse, error)
...
func (c *userClient) GetUserByMobile(ctx context.Context, in *MobileReqeust, opts ...grpc.CallOption) (*UserInfoResponse, error) {
...
func (c *userClient) GetUserById(ctx context.Context, in *IdReqeust, opts ...grpc.CallOption) (*UserInfoResponse, error) {
	out := new(UserInfoResponse)
...
type UserServer interface {
	...
	GetUserByMobile(context.Context, *MobileReqeust) (*UserInfoResponse, error)
	GetUserById(context.Context, *IdReqeust) (*UserInfoResponse, error)
...
func (UnimplementedUserServer) GetUserByMobile(context.Context, *MobileReqeust) (*UserInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserByMobile not implemented")
}
func (UnimplementedUserServer) GetUserById(context.Context, *IdReqeust) (*UserInfoResponse, error) {
...
func _User_GetUserByMobile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserByMobile(ctx, req.(*MobileReqeust))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_GetUserById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserById(ctx, req.(*IdReqeust))
	}
	return interceptor(ctx, in, info, handler)
}
