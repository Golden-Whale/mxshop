...
_MOBILEREQEUST = _descriptor.Descriptor(
  name='MobileReqeust',
  full_name='MobileReqeust',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='mobile', full_name='MobileReqeust.mobile', index=0,
...
_IDREQEUST = _descriptor.Descriptor(
  name='IdReqeust',
  full_name='IdReqeust',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='ID', full_name='IdReqeust.ID', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['MobileReqeust'] = _MOBILEREQEUST
...
MobileReqeust = _reflection.GeneratedProtocolMessageType('MobileReqeust', (_message.Message,), {
  'DESCRIPTOR' : _MOBILEREQEUST,
  '__module__' : 'user_pb2'
  # @@protoc_insertion_point(class_scope:MobileReqeust)
  })
_sym_db.RegisterMessage(MobileReqeust)

IdReqeust = _reflection.GeneratedProtocolMessageType('IdReqeust', (_message.Message,), {
  'DESCRIPTOR' : _IDREQEUST,
  '__module__' : 'user_pb2'
  # @@protoc_insertion_point(class_scope:IdReqeust)
  })
_sym_db.RegisterMessage(IdReqeust)
